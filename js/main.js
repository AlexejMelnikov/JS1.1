...
var shop = prompt("Название вашеог магазина");
var shopGoods=[], open, employers;
employers={};

mainList = {'budget': budget, "shop":shop, 'shopGoods':shopGoods, "employers":employers, "open":open};
// ввод типов товара
